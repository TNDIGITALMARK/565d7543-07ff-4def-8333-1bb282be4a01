...
export default function GamingPage() {
  ...
  const filteredProducts = useMemo(() => {
    ...
    return filtered;
  }, [gamingProducts, selectedCategories, selectedAgeRanges, selectedDifficulties, priceRange, sortBy]);
      ...
      <main>
        ...
        <div className="bg-gradient-to-r from-green-600 to-green-800 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <h1 className="text-4xl lg:text-5xl font-bold mb-4">RPG Gaming Expeditions</h1>
            <p className="text-xl lg:text-2xl text-green-100 max-w-2xl">
              Discover premium miniatures, detailed terrain, and custom creations to bring your tabletop RPG campaigns to life with legendary adventures.
            </p>
          </div>
        </div>
